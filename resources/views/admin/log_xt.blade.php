...
<div class="container mt-4">
        ...
        <section>
            ...
            <div class="table-responsive-sm mt-3 " id="xt2">
            ...
            <!-- -->
            <div class="table-responsive-sm mt-3 " id="xt" style="display:none">
                <table class="table table-hover table-light table-nowarp ">
                    <thead class="thead-light">
                        <tr>
                            <th>Id Hồ sơ</th>
    ...
    <script type="text/javascript">
        $('#search').on('keyup',function(){
            ...
            if($value != ""){
                ...
                document.getElementById("xt2").style.display = "none";
                $.ajax({
                type : 'get',
                url : '{{URL::to('admin/log-xt/search')}}',
                data:{'search':$value},
                ...
                document.getElementById("xt2").style.display = "block";
            }
        })
        </script>
        <script type="text/javascript">
