...
<div class="loader">
    ...
    <header
        @if (Request::route()->uri == "contact" || Request::route()->uri == "search-passport" || Request::route()->uri == "note")
            style="height: 50vh"
        @endif>
        ...
        <div class="boxtext-header">
            ...
            <h1 class="text-center">
                @if (Request::route()->uri == "home" || Request::route()->uri == "/")
                    VƯƠNG ĐẾN TRỜI ÂU
                @elseif(Request::route()->uri == "note")
                    HƯỚNG DẪN THỦ TỤC
                @elseif(Request::route()->uri == "contact")
